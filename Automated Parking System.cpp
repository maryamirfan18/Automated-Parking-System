...
// Checking whether the Parking lot is fully occupied or if a file operation failed
void Check(int a) {
    if (a >= 25) {
...
public:
    ...
    void DisplayParking(int US) {
        system("CLS");
        system("color 0F"); // 0 for Black background, F for Bright White text

        cout << "  __  __             _                         _____             _       \n";
        cout << " |  \\/  |           | |                       |  __ \\           | |      \n";
        cout << " | \\  / | __ _ _ __ | |_ _   _ _ __   ___ _ __| |__) |__ _ _ __ | |_ ___ \n";
        cout << " | |\\/| |/ _` | '_ \\| __| | | | '_ \\ / _ \\ '__|  _  // _` | '_ \\| __/ __|\n";
        cout << " | |  | | (_| | | | | |_| |_| | | | |  __/ |  | | \\ \\ (_| | | | | |_\\__ \\\n";
        cout << " |_|  |_|\\__,_|_| |_|\\__|\\__,_|_| |_|\\___|_|  |_|  \\_\\__,_|_| |_|\\__|___/\n\n";
...
public:
    ...
    File() {
        ...
        // Reading data for available spots from file
...
public:
    ...
    if (age < 18) {
        cout << "Only ages 18 and above are allowed to park." << endl;
    ...
    // Checking if the file outputs data or exception has occurred
    bool DataOut() {
        DisplayParking(usedSpots);
